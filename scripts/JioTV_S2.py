...
def convert_channel(channel):
    ...
    # GmaxHub Branding applied purely to display names
    lines.append(f'#EXTINF:-1 tvg-id="{channel["id"]}" tvg-name="{channel["name"]} | GmaxHub" tvg-logo="{channel["logo"]}" group-title="{channel["group"]}",{channel["name"]} | GmaxHub')
    ...
    # User-Agent (Keeping exact functional UA)
...
def generate_converted_m3u():
    ...
    print("=" * 60)
    print("M3U to Kodi Format Converter - GmaxHub Edition")
    print("=" * 60)
    ...
    try:
        ...
        print("\n[*] Converting channels...")
        output_file = "Playlists/JioTV_S2.m3u"
