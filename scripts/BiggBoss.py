...
def generate_m3u(data, cookie, output_file):
    ...
    for item in data:
        ...
        # Fully branded for GmaxHub
        lines.append(
            f'#EXTINF:-1 tvg-name="{name} | GmaxHub" tvg-logo="{logo}" group-title="{category}", {name} | GmaxHub'
        )
...
def main():
    ...
    json_url = 'https://sportlink18.pages.dev/bb.json'
    
    # Pointing the output directly into your new Playlists folder
    output = 'Playlists/BiggBoss.m3u'
